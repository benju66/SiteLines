...
export const INVOICES: Invoice[] = [
  // SC-25-117-220 Mechanical & Plumbing (Northline) — 2 pay apps; latest Under Review.
  {
    ...
    commitmentId: 'commitments:9001', period: '04/01/26 - 04/30/26', billingDate: '2026-05-05', status: 'Approved', final: false, isLatest: false,
  ...
  },
  {
    ...
    commitmentId: 'commitments:9001', period: '05/01/26 - 05/31/26', billingDate: '2026-06-05', status: 'Under Review', final: false, isLatest: true,
  ...
  // SC-25-117-092 Drywall & Paint (Summit) — 2 pay apps; latest Approved.
  {
    ...
    commitmentId: 'commitments:9002', period: '04/01/26 - 04/30/26', billingDate: '2026-05-05', status: 'Approved', final: false, isLatest: false,
  ...
  },
  {
    ...
    commitmentId: 'commitments:9002', period: '05/01/26 - 05/31/26', billingDate: '2026-06-05', status: 'Approved', final: false, isLatest: true,
  ...
  // SC-25-117-260 Electrical (Granite State) — single pay app, latest Approved.
  {
    ...
    commitmentId: 'commitments:9003', period: '05/01/26 - 05/31/26', billingDate: '2026-06-05', status: 'Approved', final: false, isLatest: true,
  ...
  // PO-25-117-061 Appliance Package (Lakeside) — single pay app, final.
  {
    ...
    commitmentId: 'commitments:9004', period: '05/01/26 - 05/31/26', billingDate: '2026-06-05', status: 'Approved', final: true, isLatest: true,
